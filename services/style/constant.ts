...
const SIZE_XD_DEFAULT = {
    ...
    MAIN_SIDE_FRAME_HEIGHT: 1037.95,
    RIGHT_SIDE_FRAME_WIDTH: 1383.94,
    LEFT_SIDE_FRAME_WIDTH: 1821 - 1383.94,
    BURGER: {
        WIDTH: 67,
        HEIGHT: 69
    },
...
const SIZE_ELEMENTS_ACTUAL_VIEW_PORT = {
    MAIN_FRAME_HEIGHT: (actualViewPortWidth: number) => actualViewPortWidth * (SIZE_XD_DEFAULT.MAIN_SIDE_FRAME_HEIGHT / SIZE_XD_DEFAULT.WINDOW_HEIGHT),
    HEIGHT_MAIN_FRAME: (actualViewPortWidth: number) => actualViewPortWidth * (SIZE_XD_DEFAULT.MAIN_SIDE_FRAME_HEIGHT / SIZE_XD_DEFAULT.MAIN_SIDE_FRAME_WIDTH),
    POSITION_GALLERY_ROW_TOP: (actualViewPortWidth: number) => actualViewPortWidth * (SIZE_XD_DEFAULT.POSITION_GALLERY_ROW_TOP.TOP / SIZE_XD_DEFAULT.MAIN_SIDE_FRAME_WIDTH),
...
export {
    SIZE_ELEMENTS_ACTUAL_VIEW_PORT, THEME, SIZE_XD_DEFAULT
}