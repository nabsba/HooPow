...
const SIZE_ELEMENTS_ACTUAL_VIEW_PORT = {
    ...
    BURGER: (actualViewPortWidth: number) => { return { WIDTH: actualViewPortWidth * SIZE_XD_DEFAULT.BURGER.WIDTH / SIZE_XD_DEFAULT.MAIN_SIDE_FRAME_WIDTH, HEIGHT: actualViewPortWidth * SIZE_XD_DEFAULT.BURGER.HEIGHT / SIZE_XD_DEFAULT.BURGER.HEIGHT } }
}
